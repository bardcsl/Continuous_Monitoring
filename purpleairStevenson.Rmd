...
if (sensor_loc == 1){ 
  ...
  purple_airc$`PM10_ug/m3_avg` <- (purple_airc$`PM10_CF1_ug/m3.primA`+purple_airc$`PM10_CF1_ug/m3.primB`)/2
  }
...
googlepath <- paste( "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/PURPLE AIR/Processed Data/", path_name, sep = "")
...
master <- drive_download(
  "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/PURPLE AIR/Master/stevenson_purpleair_master.csv",
  overwrite = TRUE
)

#binding the new month's data to master and creating new master csv file
fm <- read_csv(master)
newmaster <- bind_rows(fm, purple_airc)
...
nmaster <- drive_upload("stevenson_purpleair_master.csv", type = "csv", 
                  path = "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/PURPLE AIR/Master/stevenson_purpleair_master.csv", overwrite = TRUE)
