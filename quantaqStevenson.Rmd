...
name_path <- paste("~/Shared with me/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/QAQ MOD-PM/Raw Data/Final/", month_name, name_file, sep = "")

#Concatenate filename to googledrive directory - raw data
name_path_raw <- paste("~/Shared with me/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/QAQ MOD-PM/Raw Data/Raw/", month_name, name_file_raw, sep = "")
...
googlepath <- paste( "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/QAQ MOD-PM/Processed Data", path_name, sep = "")
...
master <- drive_download(
  "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/QAQ MOD-PM/Master/stevenson_quantaq_master.csv",
  overwrite = TRUE
)
...
nmaster <- drive_upload("stevenson_quantaq_master.csv", type = "csv", 
                  path = "~/Community Science Lab/Monitoring Programs/Continuous Monitoring Sites/Bard Library/QAQ MOD-PM/Master/stevenson_quantaq_master.csv", overwrite = TRUE)
